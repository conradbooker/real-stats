...
struct LineRow_Previews: PreviewProvider {
    static var previews: some View {
        ...
        LineRow(line: "6", destination: "Coney Island", times: time.north[0].times, disruptions: .delayed)
