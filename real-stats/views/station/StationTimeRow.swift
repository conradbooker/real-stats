                        ...
                        ZStack {
                            ...
                            HStack(spacing: 0) {
                                ...
                                VStack(alignment: .leading) {
                                    if direction == "N"{
                                        Text(stationsDict[
                                            trainTimes.north?[line]??[times[0]]?.destination ?? ""
                                        ]?.short1 ?? "")
                                            .fontWeight(.bold)
                                        Text("trip: \(trainTimes.north?[line]??[times[0]]?.tripID ?? "ur mom")")
                                    } else {
                                        Text(stationsDict[
                                            trainTimes.south?[line]??[times[0]]?.destination ?? ""
                                        ]?.short1 ?? "")
                                            .fontWeight(.bold)
                                        Text("trip: \(trainTimes.south?[line]??[times[0]]?.tripID ?? "ur mom")")
                                    }
                                }
                                Spacer()
